...
public class PlantCareController {
    ...
    @GetMapping(value = "/{plantCareId}/get-info")
    public PlantCareInfoDomain getPlantCareInfo(@PathVariable int plantCareId) {
        return plantCareService.getPlantCareInfo(plantCareId);
    }
}
