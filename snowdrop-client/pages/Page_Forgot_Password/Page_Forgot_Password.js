...
import {image_Snowdrop_Image_link} from './assets/imageLinks.js'
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._Page}    >
			<View style = {noneModeStyles._Snowdrop_Image}    >
				<Image style={{height: "100%", width: "100%"}} source = {{uri: image_Snowdrop_Image_link}}/>
			</View>
			
			<Text style = {noneModeStyles._Send_Code_Navigation_Button}   >
				Send Code
			</Text>
			...
			<TouchableOpacity style = {noneModeStyles._Main_Navigation_Button} onPress={() => navigation.navigate('Page_Password_Reset')} >
			...
			<TextInput
				...
				style = {[noneModeStyles._Text_Field,noneModeStyles._VefificationCode_Location]}
			/>
			<TextInput
				autoFocus={true}
